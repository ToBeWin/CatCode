...
mod tests {
    ...
    fn test_cat_state_ascii_art() {
        assert!(CatState::Idle.ascii_art().contains("zzZ"));
        assert!(CatState::Thinking.ascii_art().contains("..."));
        assert!(CatState::Executing.ascii_art().contains("ﾉ"));
        assert!(CatState::Error.ascii_art().contains("!!"));
